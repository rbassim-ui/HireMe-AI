...
function submitAnswer(auto = false) {
  ...
  const score  = (auto && !answer)
    ? Math.floor(Math.random() * 3) + 1
    : simulateScore(answer);
...
function skipQuestion() {
  ...
  answers.push('[Passé]');
  scores.push(0);
  showFeedback(0, "Vous avez passé cette question. Essayez de répondre à toutes les questions pour un meilleur score final.");
}
